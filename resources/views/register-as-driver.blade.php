...
@section('title', $title ?? Lang::get('seo.register_as_driver'))
...
@section('title1', $title_page ?? Lang::get('titles.register_as_driver_title'))
@section('title2', Lang::get('titles.register_as_driver_title2'))

@section('content')
    <div class="row">
        <div class="col-md-6">
            {!! Lang::get('texts.register_as_driver') !!}
        </div>
        <div class="col-md-6">
...
@section('outside_content')
    <div class="register-as-driver-full">
        <div class="service1">
            <a href="#">
                <figure><img src="{{ URL::asset('images/service01.png') }}" alt="" class="img-fluid"></figure>
        ...
        <div class="service1">
            <a href="#">
                <figure><img src="{{ URL::asset('images/service02.png') }}" alt="" class="img-fluid"></figure>
...
{{--        <div class="service1">--}}
{{--            <a href="#">--}}
{{--                <figure><img src="{{ URL::asset('images/service03.png') }}" alt="" class="img-fluid"></figure>--}}
...
{{--        <div class="service1">--}}
{{--            <a href="#">--}}
{{--                <figure><img src="{{ URL::asset('images/service04.png') }}" alt="" class="img-fluid"></figure>--}}
...
{{--                    <figure>--}}
{{--                        <img src="{{ URL::asset('images/video01.jpg') }}" alt="" class="img-responsive">--}}
{{--                        <div class="over1"></div>--}}
{{--                    </figure>--}}
{{--                </a>--}}
{{--            </div>--}}
