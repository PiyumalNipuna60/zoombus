...
@section('title', Lang::get('seo.current_driver_sales_title'))
...
@section('title1', Lang::get('titles.current_driver_sales'))
@section('title2', Lang::get('titles.current_driver_sales2'))
...
@section('content')
    ...
    <div class="transport-registered">
        ...
        <div class="transport-registered-table">
            <table id="driverCurrentSales" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                <thead>
                <tr>
